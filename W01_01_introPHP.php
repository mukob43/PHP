...
<body>
    ...
    <br>
    <div style="color: red; background-color: lightgrey; padding: 10px;">
    <?php
        echo "รายการผลไม้ <br>"; 
    ...
    <div style="color:blue; background-color: lightgray; padding: 10px;">
        <?php
            ...
            foreach ($products as $product){
                ...
                $total_price += $product["price"]; //คำนวนราคาทั้งหมด
                //$total = $total + $product['price']; //คำนวนราคาทั้งหมด     
            }
            echo "<br>";
